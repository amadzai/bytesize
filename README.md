...
> **Note:** This project was originally developed on GitLab. To view the original repository and history, see [Bytesize | GitLab](https://gitlab.com/amadzai/bytesize)
