...
- **Pages**
  ...
  - [`src/pages/UsageReport.tsx`](src/pages/UsageReport.tsx): usage report page for viewing visits and pagination (clicks, geolocation, and timestamp).
- **API and Routing**
...
- **Components**
  ...
  - [`src/components/UrlList.tsx`](src/components/UrlList.tsx): reusable usage report URL list UI.
- **Hooks**
  - [`src/hooks/useAnalyticsData.ts`](src/hooks/useAnalyticsData.ts): usage report data-fetching and pagination hook.
- **Utilities and Types**
